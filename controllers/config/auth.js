module.exports = {
    facebookAuth: {
        ...
        callbackURL:
            "https://crossorigin.me/http://localhost:3000/auth/facebook/callback"
    },
    twitterAuth: {
        consumerKey: "sOM9aZpoEyNAXKqvEUHd2O7cN",
        consumerSecret: "6I1x0PgH41AxuqtAKcfRqYtWDMKNv0TBaaoegW3RP3o1ks7NPk",
        callbackURL:
            "https://crossorigin.me/http://localhost:3000/auth/twitter/callback"
    },
    googleAuth: {
        //FOR DEV
        ...
        //FOR PROD
        clientID:
            "243612288079-f5s6vep0ag5frfluh0l1bng60kkncsu8.apps.googleusercontent.com",
