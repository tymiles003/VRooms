...
import AnnotationVideoAframe from "./aframe/AnnotationVideoAframe";
...
class ShowroomVideoMain extends React.Component {
    constructor(props) {
        super(props);
...
export default ShowroomVideoMain;
